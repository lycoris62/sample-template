package ex.sample.domain.sample1.service;
...
import ex.sample.domain.sample1.mapper.SampleMapper;
import ex.sample.domain.sample1.repository.SampleRepository;
